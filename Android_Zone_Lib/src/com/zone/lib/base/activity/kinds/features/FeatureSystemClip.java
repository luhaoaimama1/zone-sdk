...
public abstract class FeatureSystemClip extends ExtraFeature {
    private String saveFolder = "";
    private Uri savePath = null;

    public FeatureSystemClip(Activity activity, String saveFolder) {
        super(activity);
...
//		 intent.putExtra("outputY", outputY);
        ...
        LogZSDK.INSTANCE.d("savePath Uri:" + savePath);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        switch (RequestCodeConfig.getSwitchRequestCode(requestCode)) {
            case RequestCodeConfig.Feature_SystemClip__REQUESTCODE_Clip:
                if (intent != null) {
                    LogZSDK.INSTANCE.d("onActivityResult  savePath:" + savePath);
