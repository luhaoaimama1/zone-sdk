 ...
 * @date 14-11-7
 */
public class Un2Install_PackageUtil {
    /**
    ...
    public static int getInstallLocation() {
        ShellUtil.CommandResult commandResult = ShellUtil.execCommand(
                "LD_LIBRARY_PATH=/vendor/com.zone.lib:/system/com.zone.lib pm get-install-location", false, true);
    ...
    public static boolean isInsatalled(Context context, String pkg) {
        if (!EmptyCheck.isEmpty(pkg)) {
            List<PackageInfo> list = getInsatalledPackages(context);
            if (!EmptyCheck.isEmpty(list)) {
