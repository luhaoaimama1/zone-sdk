package com.zone.lib.utils.system_hardware_software_receiver_shell.shell;
...
public class SilentInstaller {
    ...
    public int uninstallSilent(Context context, String packageName, boolean isKeepData) {
         ...
         **/
        StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=/vendor/com.zone.lib:/system/com.zone.lib pm uninstall")
                .append(isKeepData ? " -k " : " ").append(packageName.replace(" ", "\\ "));
        ShellUtil.CommandResult commandResult = ShellUtil.execCommand(command.toString(), !Un2Install_PackageUtil.isSystemApplication(context), true);
    ...
    public int installSilent(Context context, String filePath, String pmParams) {
         ...
         **/
        StringBuilder command = new StringBuilder().append("LD_LIBRARY_PATH=/vendor/com.zone.lib:/system/com.zone.lib pm install ")
        ...
        ShellUtil.CommandResult commandResult = ShellUtil.execCommand(command.toString(),
                !Un2Install_PackageUtil.isSystemApplication(context), true);
        if (commandResult.responseMsg != null
                && (commandResult.responseMsg.contains("Success") || commandResult.responseMsg.contains("success"))) {
    ...
    private String getInstallLocationParams() {
        int location = Un2Install_PackageUtil.getInstallLocation();
        switch (location) {
