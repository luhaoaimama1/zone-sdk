 ...
 */
public class KindControl extends ZActivityCallback {
    public Map<Class, ZActivityCallback> controlMap = new HashMap<>();
    ...
    public void put(Class key, ZActivityCallback value) {
        controlMap.put(FeaturesKind.class, new FeaturesKind());
    }

    @Override
    public void onCreate(Bundle bundle, Activity context) {
        for (Map.Entry<Class, ZActivityCallback> item : controlMap.entrySet())
