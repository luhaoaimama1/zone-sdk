...
public class HorizontalScrollView_InnerConfict1 extends LinearLayout{
	private static final String TAG = "HorizontalScrollView_InnerConfict1";
	...
	public HorizontalScrollView_InnerConfict1(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public HorizontalScrollView_InnerConfict1(Context context) {
		this(context,null);
	}
	//调用此方法滚动到目标位置
