...
public class FbRelativeLayout extends RelativeLayout implements IFocus {
    ...
    public FbRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FbRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public FbRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
