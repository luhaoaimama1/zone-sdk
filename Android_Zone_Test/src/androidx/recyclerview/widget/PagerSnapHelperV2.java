 ...
 */
public class PagerSnapHelperV2 extends SnapHelper {
    ...
    private View findCenterView(RecyclerView.LayoutManager layoutManager,
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (isClosetViewNewLogic(layoutManager,absClosest, absDistance, child)) {
    ...
    //<editor-fold desc="相对PagerSnapHelper新增逻辑">
    protected boolean isClosetViewNewLogic(RecyclerView.LayoutManager layoutManager, int absClosest, int absDistance, @Nullable View child) {
        ...
        return absDistance < absClosest && visibility != View.GONE;
    }
    //</editor-fold>
